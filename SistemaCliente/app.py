...
if "rol_actual" not in st.session_state:
    st.session_state.rol_actual = "Cliente"
...
with col_form:
    ...
    # El operador y administrador pueden registrar datos nuevos
    if st.session_state.rol_actual in ["Administrador", "Operador"]:
        ...
        st.warning("⚠️ Tu rol actual no tiene permisos para registrar nuevos clientes.")
...
# ==========================================
# SECCIÓN: MODIFICAR (Solo Administrador)
# ==========================================
if st.session_state.clientes:
    st.markdown("---")
